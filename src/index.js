...
(function () {
    var bigint = require('big-integer'),
        ...
        ExpNormalizer = require('@theoryofnekomata/normalize-exponential');
     ...
     * @returns {NumberName} The converter.
     */
    module.exports = function numberName(theConfig) {
         ...
         * @returns {Array{String}} The string split in three characters.
         */
        ...
        function getKiloKilo(latinPowerKilo, milliaCount, kilos) {
            var kiloOnes = latinPowerKilo % 10,
                kiloTens = Math.floor(latinPowerKilo / 10) % 10,
                kiloHundreds = Math.floor(latinPowerKilo / 100) % 10,
         ...
         * @param {Array{Number}} kilos All the kilos.
